...
public class IDPSelfGenKeyStoreFile extends CustomJavaAction<java.lang.Boolean>
{
	...
	public IDPSelfGenKeyStoreFile(IContext context, IMendixObject SSOConfiguration, IMendixObject keyStore)
	{
		super(context);
	...
	public java.lang.Boolean executeAction() throws Exception
	{
		...
		if(this.keyStore == null){
			...
			saml20.proxies.SSOConfiguration ReloadSSOConfiguration = SAMLUtil.getSSOConfig(getContext(),this.SSOConfiguration.getAlias());
			if(!ReloadSSOConfiguration.getEncryptionKeyLength().equals(SSOConfiguration.getEncryptionKeyLength())){
				KeyStoreHelper.generateSelfKeyPair(this.SSOConfiguration,getContext());
			}
	   }
		return true;
