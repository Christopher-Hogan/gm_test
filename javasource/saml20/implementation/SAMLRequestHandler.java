...
//			if ( this.ssoConfigurationList != null ) {
	...
	private void updateSSOConfigurationInSAMLRequestContext(SAMLSessionInfo sessionInfo, SAMLRequestContext samlContext) throws SAMLException {
		if (sessionInfo != null && sessionInfo.getEntityId() != null) {
